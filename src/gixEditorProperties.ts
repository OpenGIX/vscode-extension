 ...
 */
export class GIXEditorProperties implements vscode.WebviewViewProvider {
  public static readonly viewType = "panel.gixEditorProperties";
  ...
  public static register(context: vscode.ExtensionContext): vscode.Disposable {
    vscode.commands.registerCommand(
      "panel.GIXEditorProperties.AddProperty",
      async () => {
    ...
    return vscode.window.registerWebviewViewProvider(
      this.viewType,
      new GIXEditorProperties(context)
    );
  }
