...
export class BasicEditorCanvas implements vscode.CustomTextEditorProvider {
  ...
  public static register(context: vscode.ExtensionContext): vscode.Disposable {
    return vscode.window.registerCustomEditorProvider(
      BasicEditorCanvas.viewType,
      new BasicEditorCanvas(context)
    );
  }
  ...
  private getHtmlForWebview(
    ...
    const styleCanvasUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this.context.extensionUri, "media", "canvas.css")
    );
    const styleLeafletUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this.context.extensionUri, "media", "leaflet.css")
    );
    const scriptLeafletUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this.context.extensionUri, "media", "leaflet.js")
    );
    const scriptGeoJSONUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this.context.extensionUri, "media", "geojson.js")
    );
